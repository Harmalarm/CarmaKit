...
from carmakit_addon.utils.binary_reader import BinaryReader
from carmakit_addon.utils.binary_writer import BinaryWriter
...
class TestReadFunctions:
    ...
    def test_read_uint32(self) -> None:
        ...
        f = io.BytesIO(data)
        result = BinaryReader.read_uint32(f)
    ...
    def test_read_int32_positive(self) -> None:
        ...
        f = io.BytesIO(data)
        result = BinaryReader.read_int32(f)
        assert result == 127
    ...
    def test_read_uint16(self) -> None:
        ...
        data = b'\x12\x34'
        f = io.BytesIO(data)
        result = BinaryReader.read_uint16(f)
    ...
    def test_read_int16_positive(self) -> None:
        ...
        data = b'\x00\x7F'  # 127
        f = io.BytesIO(data)
        result = BinaryReader.read_int16(f)
        assert result == 127
    ...
    def test_read_uint8(self) -> None:
        ...
        data = b'\xAB'
        f = io.BytesIO(data)
        result = BinaryReader.read_uint8(f)
        assert result == 0xAB
    ...
    def test_read_float32(self) -> None:
        ...
        f = io.BytesIO(data)
        result = BinaryReader.read_float32(f)
    ...
    def test_read_float32_array(self) -> None:
        ...
        f = io.BytesIO(data)
        result = BinaryReader.read_float32_array(f, 3)
        assert len(result) == 3
    ...
    def test_read_null_terminated_string(self) -> None:
        ...
        f = io.BytesIO(data)
        result = BinaryReader.read_null_terminated_string(f)
        assert result == "Hello"
...
class TestRoundTrip:
    ...
    def test_uint32_round_trip(self) -> None:
        ...
        value = 0xDEADBEEF
        f = io.BytesIO()
        BinaryWriter.write_uint32(f, value)
        f.seek(0)
        result = BinaryReader.read_uint32(f)
        assert result == value
    ...
    def test_float32_round_trip(self) -> None:
        ...
        value = 3.14159
        f = io.BytesIO()
        BinaryWriter.write_float32(f, value)
        f.seek(0)
        result = BinaryReader.read_float32(f)
    ...
    def test_string_round_trip(self) -> None:
        ...
        value = "TestModel"
        f = io.BytesIO()
        BinaryWriter.write_null_terminated_string(f, value)
        f.seek(0)
        result = BinaryReader.read_null_terminated_string(f)
        assert result == value
